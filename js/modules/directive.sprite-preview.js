define(['angular', 'app'], function (angular, app) {
    ...
    SpritePreviewDirective.$inject = ['$timeout'];
    app.directive('spritePreview', SpritePreviewDirective);

    function SpritePreviewDirective($timeout) {
        return {
            restrict: 'E',
            scope: {
                source: '=source',
            ...
            link: spritePreviewLink
        };

        function spritePreviewLink($scope, $elem) {
            var promise;
